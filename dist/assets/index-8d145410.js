...
}`,fragmentShaderSourceCode=`#version 300 es
...
void main(void) {
    ...
    outColor = v_color;
}`;var EPSILON=1e-6,ARRAY_TYPE=typeof Float32Array<"u"?Float32Array:Array;Math.hypot||(Math.hypot=function(){for(var e=0,t=arguments.length;t--;)e+=arguments[t]*arguments[t];return Math.sqrt(e)});function create(){var e=new ARRAY_TYPE(16);return ARRAY_TYPE!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=0,e[12]=0,e[13]=0,e[14]=0),e[0]=1,e[5]=1,e[10]=1,e[15]=1,e}function identity(e){return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function scale(e,t,s){var a=s[0],n=s[1],r=s[2];return e[0]=t[0]*a,e[1]=t[1]*a,e[2]=t[2]*a,e[3]=t[3]*a,e[4]=t[4]*n,e[5]=t[5]*n,e[6]=t[6]*n,e[7]=t[7]*n,e[8]=t[8]*r,e[9]=t[9]*r,e[10]=t[10]*r,e[11]=t[11]*r,e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15],e}function rotateX(e,t,s){var a=Math.sin(s),n=Math.cos(s),r=t[4],i=t[5],l=t[6],u=t[7],c=t[8],d=t[9],h=t[10],m=t[11];return t!==e&&(e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15]),e[4]=r*n+c*a,e[5]=i*n+d*a,e[6]=l*n+h*a,e[7]=u*n+m*a,e[8]=c*n-r*a,e[9]=d*n-i*a,e[10]=h*n-l*a,e[11]=m*n-u*a,e}function rotateZ(e,t,s){var a=Math.sin(s),n=Math.cos(s),r=t[0],i=t[1],l=t[2],u=t[3],c=t[4],d=t[5],h=t[6],m=t[7];return t!==e&&(e[8]=t[8],e[9]=t[9],e[10]=t[10],e[11]=t[11],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15]),e[0]=r*n+c*a,e[1]=i*n+d*a,e[2]=l*n+h*a,e[3]=u*n+m*a,e[4]=c*n-r*a,e[5]=d*n-i*a,e[6]=h*n-l*a,e[7]=m*n-u*a,e}function orthoNO(e,t,s,a,n,r,i){var l=1/(t-s),u=1/(a-n),c=1/(r-i);return e[0]=-2*l,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=-2*u,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=2*c,e[11]=0,e[12]=(t+s)*l,e[13]=(n+a)*u,e[14]=(i+r)*c,e[15]=1,e}var ortho=orthoNO;function lookAt(e,t,s,a){var n,r,i,l,u,c,d,h,m,o,_=t[0],p=t[1],f=t[2],b=a[0],g=a[1],v=a[2],x=s[0],y=s[1],w=s[2];return Math.abs(_-x)<EPSILON&&Math.abs(p-y)<EPSILON&&Math.abs(f-w)<EPSILON?identity(e):(d=_-x,h=p-y,m=f-w,o=1/Math.hypot(d,h,m),d*=o,h*=o,m*=o,n=g*m-v*h,r=v*d-b*m,i=b*h-g*d,o=Math.hypot(n,r,i),o?(o=1/o,n*=o,r*=o,i*=o):(n=0,r=0,i=0),l=h*i-m*r,u=m*n-d*i,c=d*r-h*n,o=Math.hypot(l,u,c),o?(o=1/o,l*=o,u*=o,c*=o):(l=0,u=0,c=0),e[0]=n,e[1]=l,e[2]=d,e[3]=0,e[4]=r,e[5]=u,e[6]=h,e[7]=0,e[8]=i,e[9]=c,e[10]=m,e[11]=0,e[12]=-(n*_+r*p+i*f),e[13]=-(l*_+u*p+c*f),e[14]=-(d*_+h*p+m*f),e[15]=1,e)}var commonjsGlobal=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},webglObjLoader_min={exports:{}};(function(module,exports){(function(e,t){module.exports=t()})(typeof self<"u"?self:commonjsGlobal,function(){return function(e){var t={};function s(a){if(t[a])return t[a].exports;var n=t[a]={i:a,l:!1,exports:{}};return e[a].call(n.exports,n,n.exports,s),n.l=!0,n.exports}return s.m=e,s.c=t,s.d=function(a,n,r){s.o(a,n)||Object.defineProperty(a,n,{enumerable:!0,get:r})},s.r=function(a){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(a,"__esModule",{value:!0})},s.t=function(a,n){if(1&n&&(a=s(a)),8&n||4&n&&typeof a=="object"&&a&&a.__esModule)return a;var r=Object.create(null);if(s.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:a}),2&n&&typeof a!="string")for(var i in a)s.d(r,i,function(l){return a[l]}.bind(null,i));return r},s.n=function(a){var n=a&&a.__esModule?function(){return a.default}:function(){return a};return s.d(n,"a",n),n},s.o=function(a,n){return Object.prototype.hasOwnProperty.call(a,n)},s.p="/",s(s.s=0)}({"./src/index.ts":function(module,__webpack_exports__,__webpack_require__){eval(`__webpack_require__.r(__webpack_exports__);
...
//# sourceURL=webpack:///multi_./src/index.ts?`)}})})})(webglObjLoader_min);var webglObjLoader_minExports=webglObjLoader_min.exports;const kyub=`# cube.obj
#
...
f  2//1  6//1  8//1 
f  2//1  8//1  4//1 
`;function createShader(e,t,s){var a=e.createShader(t);if(e.shaderSource(a,s),e.compileShader(a),!e.getShaderParameter(a,e.COMPILE_STATUS)){var n=e.getShaderInfoLog(a);throw`Could not compile WebGL program. 

`+n}return a}let canvas=document.querySelector("#screensaver");canvas.height=360;canvas.width=360;const gl=canvas.getContext("webgl2");let program=gl.createProgram();const vertexShader=createShader(gl,gl.VERTEX_SHADER,vertexShaderSourceCode),fragmentShader=createShader(gl,gl.FRAGMENT_SHADER,fragmentShaderSourceCode);gl.attachShader(program,vertexShader);gl.attachShader(program,fragmentShader);gl.linkProgram(program);if(!gl.getProgramParameter(program,gl.LINK_STATUS)){var info=gl.getProgramInfoLog(program);throw`Could not compile WebGL program. 

`+info}gl.useProgram(program);const uModelMatrixPointer=gl.getUniformLocation(program,"u_model_matrix"),uViewMatrixPointer=gl.getUniformLocation(program,"u_view_matrix"),uProjectionMatrixPointer=gl.getUniformLocation(program,"u_projection_matrix"),vertexPositionAttribute=gl.getAttribLocation(program,"a_position");gl.enableVertexAttribArray(vertexPositionAttribute);gl.enable(gl.DEPTH_TEST);const CONST_VIEWS=[0,0,0,0,0,-1,0,1,0];var VIEWS=CONST_VIEWS;const CONST_PROJECTION_ARRAY=[-10,10,-10,10,-10,10];var PROJECTION_ARRAY=CONST_PROJECTION_ARRAY;function useLibrary(e){var t=new webglObjLoader_minExports.OBJ.Mesh(e),s=create();ortho(s,...PROJECTION_ARRAY);var a=create();lookAt(a,new Float32Array(VIEWS.slice(0,3)),new Float32Array(VIEWS.slice(3,6)),new Float32Array(VIEWS.slice(6,9)));var n=create();scale(n,n,[5,5,5]),rotateX(n,n,Math.PI/4),rotateZ(n,n,Math.PI/4),gl.uniformMatrix4fv(uModelMatrixPointer,!1,new Float32Array(n)),gl.uniformMatrix4fv(uViewMatrixPointer,!1,new Float32Array(a)),gl.uniformMatrix4fv(uProjectionMatrixPointer,!1,new Float32Array(s));let r=webglObjLoader_minExports.OBJ.initMeshBuffers(gl,t);gl.bindBuffer(gl.ARRAY_BUFFER,r.vertexBuffer),gl.vertexAttribPointer(vertexPositionAttribute,r.vertexBuffer.itemSize,gl.FLOAT,!1,0,0),gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER,r.indexBuffer),gl.clearColor(0,0,0,1),gl.clear(gl.COLOR_BUFFER_BIT),gl.drawElements(gl.TRIANGLES,r.indexBuffer.numItems,gl.UNSIGNED_SHORT,0)}useLibrary(kyub);
